/**
 * Board类单元测试
 * Week 2 - TC-001 至 TC-009
 */

import { describe, it, expect, beforeEach } from 'vitest';
import { Board } from '../../game/core/board';

describe('Board - TC-001: 初始化测试', () => {
  it('应该创建15x15的空棋盘', () => {
...
describe('Board - TC-002: 自定义大小初始化测试', () => {
  it('应该创建指定大小的棋盘', () => {
...
describe('Board - TC-006: 获取已占位置测试', () => {
  it('应该返回所有已落子位置', () => {
    const board = new Board();
    board.setCell(7, 7, 'black');
    board.setCell(7, 8, 'white');
...
describe('Board - TC-009: 越界访问抛出异常测试', () => {
  let board: Board;
